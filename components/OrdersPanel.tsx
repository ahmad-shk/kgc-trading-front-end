                          ...
                          activeTab === "Order History" ? (
                            ...
                            activeTab === "Trade History" ? (
                              <>
                                ...
                                <td className={`py-2 px-2 ${index % 2 === 0 ? "text-[#EDB546]" : "text-[#d4b26f]"} text-sm font-medium`}  onClick={()=>{ item?.transactionHash? window.open(`https://testnet.bscscan.com/tx/${item?.transactionHash}`, "_blank", "noopener,noreferrer"):""}} >{item?.transactionHash ? `${item?.transactionHash.slice(0, 10)}...${item?.transactionHash.slice(-10)}`:"........."}</td>
                                <td className={`py-2 px-2 ${index % 2 === 0 ? "text-[#EDB546]" : "text-[#d4b26f]"} text-sm font-medium`}>
                                  {new Date(item?.createdAt).toLocaleString()}
                                </td>
                              </>
