  ...
  return (
    <div className="rounded-lg w-full text-[#848E9C] -text-white">
      ...
      <div className="flex items-center bg-transparent px-4 py-2 rounded-[6px] mb-4 border-2 border-gray-800">
        <span className="text-[#edb546] mr-2 text-lg">
      ...
      <div className="flex items-center border-b border-[#2B3139]">
        <button
          ...
          className={`px-3 py-2 text-sm ${activeTab === "New" ? "text-[#edb546] font-bold border-b-2 border-[#edb546]" : "text-[#848e9c]"}`}
        >
          New
        </button>
        <button
          onClick={() => setActiveTab("USDT")}
          className={`px-3 py-2 text-sm ${activeTab === "USDT" ? "text-[#edb546] font-bold border-b-2 border-[#edb546]" : "text-[#848e9c]"}`}
        >
          USDT
        </button>
        <button
          onClick={() => setActiveTab("BTC")}
          className={`px-3 py-2 text-sm ${activeTab === "BTC" ? "text-[#edb546] font-bold border-b-2 border-[#edb546]" : "text-[#848e9c]"}`}
        >
          BTC
        </button>
        <button
          onClick={() => setActiveTab("ETH")}
          className={`px-3 py-2 text-sm ${activeTab === "ETH" ? "text-[#edb546] font-bold border-b-2 border-[#edb546]" : "text-[#848e9c]"}`}
        >
          ETH
        </button>
        <button
          onClick={() => setActiveTab("USDC")}
          className={`px-3 py-2 text-sm ${activeTab === "USDC" ? "text-[#edb546] font-bold border-b-2 border-[#edb546]" : "text-[#848e9c]"}`}
        >
          USDC
        </button>
      </div>
      ...
      {/* Table Header */}
       <div className="grid grid-cols-3 items-center text-[11px] px-2 py-2 text-[#848E9C] font-semibold">
        <div className="flex items-center gap-2">Coin</div>
        <div className="text-right sm:text-end">Last Price</div>
        <div className="text-right">24h Changes</div>
      </div>
      {/* Table Rows */}
